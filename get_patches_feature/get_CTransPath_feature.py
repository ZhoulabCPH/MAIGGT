...
slides_path_224 = rf'../datasets/Patches_224'
save_path_224 = rf'../datasets/WSIs_CTransPath_224'
get_CTransPath_features(slides_path_224, save_path_224)
slides_path_512 = rf'../datasets/Patches_512'
save_path_512 = rf'../datasets/WSIs_CTransPath_512'
get_CTransPath_features(slides_path_512, save_path_512)